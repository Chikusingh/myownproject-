          ...
          <div class="navigation ">
            <nav>
              <ul class="sf-menu">
               ...
               <li class="current"><a href="vendor_details/dashboard.php">Staff Pannel</a></li>
               <li><a href="menu_pannel/ashboard.php">Menu Pannel</a></li>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - July 28, 2014!</div>
  <div class="container">
    <div class="row">
      <div class="grid_12">
        <h3>About Us</h3>
        <img src="images/lpu_image.jpg" alt="" class="img_inner fleft">
      ...
      <div class="row">
        ...
        <div class="grid_4">
          <div class="block-3">
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Lovely Student's</a></div>
        ...
        <div class="grid_4">
          <div class="block-3">
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#"> Other </a></div>
        ...
        <div class="grid_4">
          <div class="block-3">
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#">outer person</a></div>
