  ...
  <div class="container">
    <div class="row">
      <div class="grid_12 rel">
        <h1>
          <a href="index.html">
            <img src="images/ums_logo.png" alt="Logo alt">
          </a>
        </h1>
      </div>
    </div>
          ...
          <div class="navigation ">
            <nav>
              <ul class="sf-menu">
               ...
               <li><a href="vendor_details/dashboard.php">Staff Pannel</a></li>
               <li class="current"><a href="menu_pannel/dashboard.php">Menu Pannel</a></li>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - July 28, 2014!</div>
  <div class="container">
    <div class="row">
      ...
      <div class="grid_2">
        <div class="text2 color1"><a href="#">Đ•estibu dertolo</a></div>Curabitur vel lorem sitmet nulla ullamcorper mentum In vitae dert rius augue, eu consectetur ligulaam dui eros dertolisce dertoloing quam id risus sagittis
      </div>
      <div class="grid_2">
